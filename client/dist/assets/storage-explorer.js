...
define('storage-explorer/models/row', ['exports', 'ember-data'], function (exports, DS) {
    ...
    var row = DS['default'].Model.extend({
        ...
        columns: DS['default'].hasMany("column", { embedded: "always" })
    });
...
define('storage-explorer/serializers/column', ['exports', 'ember-data'], function (exports, DS) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        inline(env, morph0, context, "input", [], {"value": get(env, context, "storageAccountName"), "type": "text", "class": "form-control floating-label", "placeholder": "storage account name"});
        inline(env, morph1, context, "input", [], {"value": get(env, context, "storageAccountKey"), "type": "text", "class": "form-control floating-label", "placeholder": "storage account key"});
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      ...
      return {
        ...
        render: function render(context, env, contextualElement) {
          ...
          block(env, morph1, context, "each", [get(env, context, "row.columns")], {"keyword": "column"}, child0, null);
          return fragment;
        }
      };
    }());
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph2 = dom.createMorphAt(dom.childAt(fragment, [3, 1, 1]),0,1);
        content(env, morph0, context, "tableName");
        content(env, morph1, context, "rowCount");
        block(env, morph2, context, "each", [get(env, context, "rows")], {"keyword": "row"}, child0, null);
        return fragment;
      }
    };
  }()));
...
define('storage-explorer/tests/serializers/column.jshint', function () {

  'use strict';

  module('JSHint - serializers');
  test('serializers/column.js should pass jshint', function() { 
    ok(true, 'serializers/column.js should pass jshint.'); 
  });
...
if (runningTests) {
  ...
  require("storage-explorer/app")["default"].create({"apiHost":"http://localhost:3000","LOG_RESOLVER":true,"LOG_ACTIVE_GENERATION":true,"LOG_TRANSITIONS":true,"LOG_TRANSITIONS_INTERNAL":true,"LOG_VIEW_LOOKUPS":true,"name":"storage-explorer","version":"0.0.0.dc3eade2"});
}
